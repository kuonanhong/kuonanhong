...
#'Referer':'https://www.tripadvisor.com.tw/Tourism-g298129-Chugoku-Vacations.html',        #中國地方旅遊首頁
'Referer':'',
...
urllist = [
           '/Hotels-g298129-Chugoku-Hotels.html'
           ]
...
import json
with open('TripAdvisor飯店評論中國地方精簡正式版.json', 'w') as f:                               #轉成.json檔
